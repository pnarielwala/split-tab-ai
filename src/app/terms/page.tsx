        ...
        <div className="space-y-6">
          <section className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              By accessing or using Split Tab, you agree to be bound by these
          ...
          <section className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Split Tab is a bill splitting and receipt scanning tool. It allows
              you to upload receipt images, have them parsed by AI, and split
              costs among a group of people.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              You agree not to upload illegal content or use the service for any
              unlawful purpose. You agree not to abuse or misuse the SMS
              reminder system, including attempting to send messages to people
          ...
          <section className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              You are responsible for the content you upload. Receipt images are
              sent to Google Gemini AI for processing and stored in our
              infrastructure. Do not upload images containing sensitive personal
              information beyond what is needed for bill splitting.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              By signing up, you consented to receive SMS payment reminders. You
              may opt out at any time by replying{' '}
          ...
          <section className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              uninterrupted, or that AI-parsed receipt data will be accurate.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              To the maximum extent permitted by law, Split Tab and its
